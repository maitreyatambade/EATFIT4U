...
<br>
    ...
    <div class="container">
        <div class="row">
            <form method ="post" id="contact-form" name="signin"  action="signin.php" onSubmit="return formValidation() ;" >
                <div>
                    <div class="block">
				...
				<div class="error" id="error">Unable to Login please Signup</div>
                <div class="success" id="success">Logging in</div>
            </form>
			
        </div>
		<p class="copyright" align="center" size= 20px>New here ?
<a href="signup.php"><b>Sign up</b> </a>here to be fit and to enjoy healthy life</p><br>
		<br>
<!-- footer Start -->
<footer class="footer">
	<div class="container">
